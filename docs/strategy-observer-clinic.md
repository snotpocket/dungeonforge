...
It is not possible to change the behavior of the subclasses of monster after runtime because it is already declared. It can only be declared at runtime.
